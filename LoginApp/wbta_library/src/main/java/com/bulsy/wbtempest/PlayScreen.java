...
//    float[] starpts = new float[NUM_STARS*2];
    ...
    private MainActivity_wbta act = null;
    ...
    public PlayScreen(MainActivity_wbta act) {
        this.act = act;
        ...
        try {
            ...
            Log.d(MainActivity_wbta.LOG_ID, "ReadHiScore", e);
        }
...
//            c.drawText("fps:"+fps, 50, 100, p);
            ...
            if (gameover) {
                ...
                try {
                    ...
                    Log.d(MainActivity_wbta.LOG_ID, "WriteHiScore", e);
                }
            }
        } catch (Exception e) {
